...
scriptFl <- rstudioapi::selectFile("Select data analysis script",
                                   path = "Regulation analysis - detailed script.R",
                                   filter = "R script (*.R)")
#paramFl <- choose.files("Parameters.csv", multi = FALSE)
paramFl <- rstudioapi::selectFile("Select parameters csv file",
                                   path = "Parameters.csv",
                                   filter = "csv file (*.csv)")
